...
$query="select * from cart where email= '$abc2'";
...
{
	$q=$row2['id'];
$query="SELECT * FROM products where id=$q";
$result=mysql_query($query);
...
if($x%3==0)
	...
	<div class="clear"></div></div>
			...
			<div class="rsidebar span_1_of_left">
                    ...
                    <?php
					$query=mysql_query("select * from signup where email='$abc2'");
                    ...
                    <h4>Name: <?php echo $row['name'] ?></h4>
                        ...
                        <h4>Address: <?php echo $row['address'] ?></h4>
                         ...
                         <section  class="sky-form">
                         <br>
                        <h4>Contact: <?php echo $row['phn_no'] ?></h4>
		      			 </section>
				           </section>
                    <section  class="sky-form">
                    <br>
                   ...
                   <section  class="sky-form">
                   <br>
					<h4>Amount: <?php echo "$amt" ?></h4>
                    </section>
                    <section>
                    <br>
                    <a href="edit.php"><button class="grey">Edit</button></a> <a href="confirm.php"><button class="grey">Confirm</button></a> 
                    </section>
