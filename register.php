    	      ...
    	      <h4 class="title">Create an Account</h4>
    		   <form action="add.php" method="post">
    			 <div class="col_1_of_2 span_1_of_2">
		   			 <div><p class="code">Name:</p><input type="text" name="aa"onfocus="this.value = '';" pattern="([A-Za-z]).{1,}" title="Only Alphabets" onblur="if (this.value == '') {this.value = 'Name';}"></div>
		    			<div><p class="code">Company Name:</p><input type="text" name="bb" pattern="([A-Za-z]).{1,}"  title="Only Alphabets" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Company Name';}"></div>
		    			<div><p class="code">E-Mail:</p><input type="text" value="@" onfocus="this.value = '';"  title="Wrong Email format" name="cc" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"   onblur="if (this.value == '') {this.value = 'E-Mail';}"></div>
		    			<div><p class="code">Password</p><input type="password"  onfocus="this.value = '';" pattern=".{4,}" name="dd" title=" password must be at least 5 characters" onblur="if (this.value == '') {this.value = 'password';}"></div>
		    	 </div>
		    	  <div class="col_1_of_2 span_1_of_2">	
		    		<div><p class="code">Address:</p><input type="text" onfocus="this.value = '';" name="ee" pattern="([A-Za-z]).{3,}" title="At least 4 characters" onblur="if (this.value == '') {this.value = 'Address';}"></div>
		    		<div><p class="code">Country:</p><select id="country" name="country" onchange="change_country(this.value)" class="frm-field required">
		          ...
		          <div><p class="code">City</p><input type="text" onfocus="this.value = '';" name="ff" onblur="if (this.value == '') {this.value = 'City';}"></div>
		           <div>
		          </div>
		          <p class="code">Country Code + Phone Number:</p>
		          	<input type="text" value="" class="code" name="gg"> - <input type="text" value="" class="number" name="hh" pattern="[789][0-9]{9}" title="Wrong Format">
